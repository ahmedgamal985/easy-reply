...
export default function RealTimeWebSearchFeaturePage() {
  ...
  const featureBlocks = isAr
    ? [
        {
          id: "1",
          title: "اكتشاف فجوات المعرفة",
          body: "يميّز Easy Reply متى يتجاوز السؤال السياق الحالي ويشغّل تلقائيًا بحثًا متقدمًا على الويب لتقديم إجابات دقيقة.",
          chip: "يكتشف السياق الناقص",
        },
        {
          id: "2",
          title: "بحث ذكي",
          body: "بدل الاعتماد على مطابقة كلمات بسيطة، يبني الذكاء الاصطناعي استعلامات واعية بالسياق لاسترجاع المعلومات الأكثر صلة وفائدة.",
          chip: "استعلام واعٍ بالسياق",
        },
        {
          id: "3",
          title: "تقييم المصادر",
          body: "تُرشَّح نتائج البحث حسب الصلة والمصداقية قبل الاستخدام، ما يعزّز موثوقية الردود ودقتها.",
          chip: "ترشيح حسب المصداقية",
        },
        {
          id: "4",
          title: "تكامل سلس",
          body: "تُدمَج معلومات الويب الطازجة بأسلوب طبيعي في الحوار المستمر، فتبقى المحادثة سلسة وشبه بشرية دون انتقالات مزعجة.",
          chip: "دمج طبيعي للردود",
        },
        {
          id: "5",
          title: "تعلّم مستمر",
          body: "تُحفَظ أنماط المعلومات المتكررة لتحسين سرعة الرد ودقته في المحادثات اللاحقة.",
          chip: "يتحسّن مع الوقت",
        },
      ]
    : [
        {
          ...
          body: "Easy Reply recognizes when a question exceeds current context and automatically triggers advanced web search to deliver accurate answers.",
          chip: "Detects Missing Context",
        },
        {
          id: "2",
          title: "Intelligent Search",
          body: "Instead of relying on simple keyword matching, the AI builds context-aware queries to retrieve the most relevant and useful information.",
          chip: "Context-Aware Querying",
        },
        {
          id: "3",
          title: "Source Evaluation",
          body: "Search results are filtered for relevance and credibility before being used, helping ensure responses are trustworthy and precise.",
          chip: "Credibility Filtering",
        },
        {
          id: "4",
          title: "Seamless Integration",
          body: "Fresh web information is woven naturally into ongoing dialogue so conversations stay smooth and human-like without awkward handoffs.",
          chip: "Natural Response Blending",
        },
        {
          id: "5",
          title: "Continuous Learning",
          body: "High-frequency information patterns are remembered to improve response speed and accuracy in future conversations.",
          chip: "Improves Over Time",
        },
      ];
        ...
        <section className="px-3 pt-10 sm:px-4 md:pt-16">
          <div className="mx-auto max-w-6xl rounded-[28px] bg-gradient-to-br from-cyan-50 via-white to-violet-50 px-4 pb-16 pt-8 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.7)] sm:px-6 md:pb-20 md:pt-12">
            ...
            <h1 className="mt-5 font-display text-[1.9rem] font-bold leading-[1.2] text-ink sm:text-4xl md:text-5xl">
              {isAr ? "بحث ويب لحظي لذكاء اصطناعي دقيق دائمًا" : "Real-Time Web Search for Always-Accurate AI"}
            </h1>
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "معظم روبوتات الدردشة مقيدة بمعرفة مسبقة التحميل، ما يخلق فجوات في الإجابات وإرشادات قديمة."
                : "Most chatbots are limited to preloaded knowledge, which creates gaps in answers and outdated guidance."}
            </p>
            <p className="mx-auto mt-3 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "يتصل Easy Reply بالويب في الوقت الفعلي لتقديم ردود محدثة عن الأحداث الجارية والمنتجات المحددة والمواضيع سريعة التغيّر."
                : "Easy Reply accesses the web in real time to provide up-to-date responses on current events, specific products, and fast-changing topics."}
            </p>
            <a
              href="#pricing"
        ...
        <section className="bg-white px-3 py-14 sm:px-4 md:py-20">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold leading-tight text-ink md:text-5xl">
              {isAr
                ? "Easy Reply يقدّم ذكاءًا اصطناعيًا يبقى على اطلاع في الوقت الفعلي"
                : "Easy Reply Delivers AI That Stays Informed in Real Time"}
            </h2>
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "نماذج الذكاء الاصطناعي التقليدية مقيدة بتاريخ انقطاع التدريب، ما قد يؤدي إلى إجابات قديمة أو ناقصة."
                : "Traditional AI models are constrained by training cutoffs, which can lead to outdated or incomplete answers."}
            </p>
            <p className="mx-auto mt-3 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "يشغّل Easy Reply بحثًا حيًا على الويب أثناء المحادثات ليعيد ردودًا دقيقة وواثقة، حتى للأسئلة شديدة التحديد أو الحساسة زمنيًا."
                : "Easy Reply runs live web search during conversations to return precise and confident responses, even for highly specific or time-sensitive questions."}
            </p>
          </div>
        </section>
