...
export default function HumanLikeAIPage() {
    ...
    ? [
        {
          id: "1",
          title: "حفظ السياق",
          body: "بعكس البوتات التقليدية التي تفقد تسلسل الحوار، يحافظ Easy Reply على سياق المحادثة بالكامل ليبقى النقاش مترابطًا وطبيعيًا.",
          chip: "ذاكرة سياقية مستمرة",
        },
        {
          id: "2",
          title: "ذكاء عاطفي",
          body: "يرصد Easy Reply نبرة العميل ويكيّف أسلوب الرد وفقًا لها، فيتفاعل بتعاطف عند التوتر وبإيجابية عند الحماس.",
          chip: "ردود متوافقة مع النبرة",
        },
        {
          id: "3",
          title: "فهم عميق للنية",
          body: "لا يعتمد على الكلمات المفتاحية فقط، بل يفهم المقصود الحقيقي للرسالة ليتعامل بدقة مع الاستفسارات المركبة أو غير الواضحة.",
          chip: "فهم على مستوى النية",
        },
        {
          id: "4",
          title: "حوار طبيعي",
          body: "المحادثة تسير بسلاسة دون نمط أسئلة وأجوبة جامد، ما يمنح العميل تجربة أقرب للتواصل البشري الحقيقي.",
          chip: "تدفق محادثة بشري",
        },
        {
          id: "5",
          title: "اتساق مع هوية العلامة",
          body: "يعكس Easy Reply صوت علامتك وقيمها باستمرار، ليحافظ كل رد على نفس الهوية بأسلوب واضح ومقنع.",
          chip: "تواصل مطابق للهوية",
        },
      ]
    : [
        {
          ...
          body: "Unlike template-based bots that lose track of conversations, Easy Reply keeps full context across interactions so every discussion remains coherent and naturally connected.",
          chip: "Persistent Context Memory",
        },
        {
          id: "2",
          title: "Emotional Intelligence",
          body: "Easy Reply detects sentiment and adapts tone accordingly, responding with empathy when users are frustrated and matching positive energy when prospects are excited.",
          chip: "Tone-Aware Responses",
        },
        {
          id: "3",
          title: "Deep Understanding",
          body: "Instead of reacting to simple keywords or triggers, Easy Reply interprets intent and meaning to handle complex or ambiguous messages with high accuracy.",
          chip: "Intent-Level Understanding",
        },
        {
          id: "4",
          title: "Natural Dialogue",
          body: "The conversation flows smoothly without rigid Q&A patterns, creating interactions that feel human and help strengthen customer trust over time.",
          chip: "Human-Like Conversation Flow",
        },
        {
          id: "5",
          title: "Brand Personality Alignment",
          body: "Easy Reply consistently reflects your brand voice and values, ensuring each conversation matches your identity while staying clear, persuasive, and on-brand.",
          chip: "On-Brand Communication",
        },
      ];
        ...
        <section className="px-3 pt-10 sm:px-4 md:pt-16">
          <div className="mx-auto max-w-6xl rounded-[28px] bg-gradient-to-br from-cyan-50 via-white to-violet-50 px-4 pb-16 pt-8 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.7)] sm:px-6 md:pb-20 md:pt-12">
            ...
            <h1 className="mt-5 font-display text-[1.9rem] font-bold leading-[1.2] text-ink sm:text-4xl md:text-5xl">
              {isAr ? "محادثات بشرية تقود إلى التحويل" : "Human-Like Conversations That Convert"}
            </h1>
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "معظم البوتات تبدو جامدة ومصطنعة، وهذا يسبب إحباطًا للعملاء المحتملين."
                : "Most chatbots feel scripted and impersonal, which can frustrate potential customers."}
            </p>
            <p className="mx-auto mt-3 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "يوفر Easy Reply محادثات طبيعية بأسلوب بشري، تبني الثقة وتعالج الاعتراضات وتدفع العميل نحو قرار شراء فعلي."
                : "Easy Reply runs natural human-like conversations that build trust, resolve objections, and move prospects toward real buying decisions."}
            </p>
            <p className="mx-auto mt-3 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "وهذا يحول التفاعل اليومي إلى إيراد قابل للقياس، حتى في الخدمات والمنتجات عالية القيمة."
                : "This turns everyday interactions into measurable revenue, including high-value products and services."}
            </p>
            <a
              href="#pricing"
        ...
        <section className="bg-white px-3 py-14 sm:px-4 md:py-20">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold leading-tight text-ink md:text-5xl">
              {isAr
                ? "Easy Reply يجمع تقنيات ذكاء اصطناعي متقدمة تتجاوز البوتات التقليدية"
                : "Easy Reply Combines Advanced AI Technologies Beyond Traditional Chatbots"}
            </h2>
            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "الكثير من بوتات الذكاء الاصطناعي تبدو آلية وتكشف حدودها سريعًا في المحادثات الحقيقية."
                : "Many AI chatbots sound mechanical and expose their limits quickly in real conversations."}
            </p>
            <p className="mx-auto mt-3 max-w-3xl text-base leading-relaxed text-ink-muted md:text-lg">
              {isAr
                ? "يعتمد Easy Reply على محرك محادثات متقدم يقدم تفاعلًا طبيعيًا لدرجة أن كثيرًا من المستخدمين يظنون أنهم يتحدثون مع مندوب مبيعات حقيقي. يبني الثقة ويتعامل مع الاعتراضات ويقود العميل بسلاسة نحو قرار الشراء."
                : "Easy Reply uses a proprietary conversation engine to deliver interactions so natural that users often assume they are speaking with a human sales rep. It builds trust, handles objections, and guides prospects through purchase decisions smoothly."}
            </p>
          </div>
        </section>
